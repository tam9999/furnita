...
Robin.SearchFilter = (function () {
  ...
  SearchFilter.prototype.findOrCreateField = function (group, field) {
    ...
    if (!searchField) {
      searchField = new Robin.SearchField(field)
  ...
  SearchFilter.containsOperator = function (value) {
    if (value.indexOf(Robin.SearchOperators.OR) > 0) return true

    if (value.indexOf(Robin.SearchOperators.AND) > 0) return true
